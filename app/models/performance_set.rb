class PerformanceSet < ApplicationRecord
  ...
  validates_date :start_date, on_or_after: 1.year.ago, on_or_before: 5.years.from_now
  validates_date :end_date, on_or_after: 1.year.ago, on_or_before: 5.years.from_now
